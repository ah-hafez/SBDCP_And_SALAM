...
namespace MCS.Framework.Encryption
{
    ...
    {
        // Change these keys
        private readonly byte[] Key = Encoding.UTF8.GetBytes("8080808080808080");
        // Replace 99999999 with a random numer less than 256
        private readonly byte[] Vector = Encoding.UTF8.GetBytes("8080808080808080");
