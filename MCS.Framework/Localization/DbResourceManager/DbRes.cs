...
namespace MCS.Framework.Localization
{
    ...
    public class DbRes
    {
        ...
        public static string TResource(string resId, string lang = null)
        {
            return T(resId, "Resources", lang);
        }

        public static string TValidation(string resId, string lang = null)
        {
            return T(resId, "Validation", lang);
        }
