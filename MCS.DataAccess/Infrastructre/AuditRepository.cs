...
{
    public class AuditRepository<T> : IRepository<T> where T : AuditLog
    {
        ...
        public AuditRepository(IAmbienTTransactionContextLocator ambienTTransactionContextLocator)
        {
        ...
        public AuditRepository(ISystemDefaultValuesRepository ambienTTransactionContextLocator)
        {
