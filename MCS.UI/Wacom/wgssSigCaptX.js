...
function WacomGSS_SignatureSDK(_onDetectRunning, service_port)
{
  ...
  this.WizCtl = function(_onConstructor)
  {
    ...
    //id type is string
    //X type type is sigsdkptr.Variant
    //Y type type is sigsdkptr.Variant
    ...
    //X1 type type is a number
    //Y1 type type is a number
    //X2 type type is a number
    //Y2 type type is a number
