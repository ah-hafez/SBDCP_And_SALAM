...
function DropdownlistFilterWidget() {
    ...
    */
    this.getAssociatedTypes = function () {
        return ["DropdownlistFilterWidget"];
    };
    /***
    ...
    */
    this.onRender = function (container, lang, typeName, values, cb, data) {
        ...
        this.fillDropDownList($.parseJSON(data));
    ...
    */
    ...
    //    var $this = this;
    //    $.post("/GridView/DisplayData/getallname", function (data) {
    ...
    */
    this.fillDropDownList = function (items) {
    ...
    */
    this.registerEvents = function () {
        ...
        List.change(function () {
            ...
            $("td:nth-child(" + (index + 1) + ")").each(function () {
                $(this).find('select').val(List.val());
            });



            var openedPopup = table.find(".dropdown-menu.opened");
            openedPopup.hide();
