! function (n, a, o) {
    ...
    var s = o("html"),
        l = o("body");
    if (o(n).on("load", function () {
        o("html").data("textdirection"), setTimeout(function () {
            s.removeClass("loading").addClass("loaded")
        }, 1200), o.app.menu.init(!1);
        !1 === o.app.nav.initialized && o.app.nav.init({
            speed: 300
        }), Unison.on("change", function (e) {
            o.app.menu.change()
        }), o('[data-bs-toggle="tooltip"]').tooltip({
            container: "body"
        }), 0 < o(".navbar-hide-on-scroll").length && (o(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            classes: {
                initial: "headroom",
        ...
        }), o(".navbar-hide-on-scroll.fixed-bottom").headroom({
            offset: 205,
            tolerance: 5,
            classes: {
                initial: "headroom",
            ...
            e.preventDefault(), o(this).closest(".card").children(".card-content").collapse("toggle"), o(this).closest(".card").find('[data-action="collapse"] i').toggleClass("ft-plus ft-minus")
        ...
        var e = l.data("menu");
        "horizontal-menu" != e && ("vertical-menu-modern" == l.data("menu") ? "true" === localStorage.getItem("menuLocked") && o(".main-menu-content").find("li.active").parents("li").addClass("open") : o(".main-menu-content").find("li.active").parents("li").addClass("open")), "horizontal-menu" == e && (o(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), o(".main-menu-content").find("li.active").parents("li").addClass("active")), o(".heading-elements-toggle").on("click", function () {
            o(this).parent().children(".heading-elements").toggleClass("visible")
        });
        var n = o(".chartjs"),
            a = n.children("canvas").attr("height");
        if (n.css("height", a), l.hasClass("boxed-layout") && l.hasClass("vertical-overlay-menu")) {
    ...
    }), o(a).on("click", ".sidenav-overlay", function (e) {
        return o.app.menu.hide(), !1
    }), "undefined" != typeof Hammer) {
        var e = a.querySelector(".drag-target");
        if (0 < o(e).length) new Hammer(e).on("panright", function (e) {
            if (l.hasClass("vertical-overlay-menu")) return o.app.menu.open(), !1
        });
        setTimeout(function () {
            var e, n = a.querySelector(".main-menu");
            0 < o(n).length && ((e = new Hammer(n)).get("pan").set({
                direction: Hammer.DIRECTION_ALL,
                threshold: 100
            }), e.on("panleft", function (e) {
                if (l.hasClass("vertical-overlay-menu")) return o.app.menu.hide(), !1
            }))
        }, 300);
        var t = a.querySelector(".sidenav-overlay");
        if (0 < o(t).length) new Hammer(t).on("panleft", function (e) {
            if (l.hasClass("vertical-overlay-menu")) return o.app.menu.hide(), !1
        })
    }
    o(a).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
        ...
        }, 1e3), o(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").hasClass("show") && o(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").removeClass("show"), !1
    }), o(a).on("click", ".main-menu-footer .footer-toggle", function (e) {
    ...
    }), o(".navigation").find("li").has("ul").addClass("has-sub"), o(".carousel").carousel({
        interval: 2e3
    }), o(".nav-link-expand").on("click", function (e) {
        "undefined" != typeof screenfull && screenfull.enabled && screenfull.toggle()
    }), "undefined" != typeof screenfull && screenfull.enabled && o(a).on(screenfull.raw.fullscreenchange, function () {
    ...
    }), o(a).on("click", ".mega-dropdown-menu", function (e) {
        e.stopPropagation()
    }), o(a).ready(function () {
