                ...
                if (IsMorasalteTransaction)
                {
                    try
                    {
                        ...
                        if (putResult.StatusCode == StatusCode.Ok)
                        {
                            ...
                            Word._Document document2 = Globals.ThisAddIn.Application.ActiveDocument;
                            document2.Close(Word.WdSaveOptions.wdDoNotSaveChanges);
