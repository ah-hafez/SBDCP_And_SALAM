...
{
    public class SearchCriteriaByAssignmentNoteVM
    {
        public SearchCriteriaByAssignmentNoteVM()
        {
        ...
        [CustomDisplayName("User.AssignmentNote.AssignmentNote")]
        [CustomRequired("User.AssignmentNote.AssignmentNoteRequired")]
