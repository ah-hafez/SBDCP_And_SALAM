...
{
    public class SearchCriteriaByOutboundDraftVM
    {
        public SearchCriteriaByOutboundDraftVM()
        {
            AdvancedSearch = new OutboundDraftAdvancedVM();
        }
        ...
        public OutboundDraftAdvancedVM AdvancedSearch { get; set; }
