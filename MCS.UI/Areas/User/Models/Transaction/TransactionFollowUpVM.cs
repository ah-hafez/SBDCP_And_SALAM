...
{
    public class TransactionFollowUpVM : EntityBase
    {
        public int Id { get; set; }

        //[CustomDisplayName("User.Transaction.FollowUp.Employee")]
        //[CustomRequired("User.Transaction.FollowUp.ToUserRequired")]
        //public int? UserId { get; set; }

        //[CustomDisplayName("User.Transaction.FollowUp.Entity")]
        //[CustomRequired("User.Transaction.FollowUp.OrgUnitRequired")]
