...
namespace MCS.UI.Areas.User.Models.Transaction.Outbound.External
{
    public class AddOutboundExternalBasicInfoVM : BasicInfoBaseVM
    {
        ...
        [CustomStringLength("User.OutboundExternal.BasicInfo.DirectedToLength", 50, 0)]
        ...
        [CustomDisplayName("User.Transaction.Outbound.DeliveryMethod")]
        [CustomRequired("User.Transaction.DeliveryMethodIdRequired")]
        public int? DeliveryMethodId { get; set; }

        [CustomDisplayName("User.OutboundOpen.Source")]
        [CustomRequired("User.OutboundExternal.BasicInfo.Source")]
