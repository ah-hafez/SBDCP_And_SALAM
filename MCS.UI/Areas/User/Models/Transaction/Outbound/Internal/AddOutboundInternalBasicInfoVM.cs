...
{
    public class AddOutboundInternalBasicInfoVM : BasicInfoBaseVM
    {
        ...
        [CustomDisplayName("User.OutboundInternal.BasicInfo.OriginatorOrgUnitId")]
        [CustomRequired("User.OutboundInternal.BasicInfo.OriginatorOrgUnitIdRequired")]
