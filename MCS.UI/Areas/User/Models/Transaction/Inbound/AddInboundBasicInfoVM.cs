...
{
    public class AddInboundBasicInfoVM : BasicInfoBaseVM
    {
        [CustomDisplayName("User.Inbound.BasicInfo.InboundNumber")]
        public int InboundNumber { get; set; }  //رقم القيد//
        ...
        [CustomDisplayName("User.Inbound.BasicInfo.OriginatorOrgUnitId")]
        [CustomRequired("User.Inbound.BasicInfo.OriginatorOrgUnitIdRequired")]
        public int OriginatorOrgUnitId { get; set; } //الإدارة المنشئة
        ...
        //[CustomDisplayName("User.InboundCertificate.CreatedByOrgUnit")]
        ...
        public string ConfidentialityList { get; set; }
        ...
        [Display(Name = " رقم المعاملة الصادرة ")]
        ...
        public int ReceiveMethodId { get; set; } = DeliveryMethodType.Paper.LookupIdentity(LookupCategory.DeliveryMethod, SessionInfo.CultureShortName);

        [CustomDisplayName("User.Inbound.BasicInfo.InboundDestination")]
        [CustomRequired("User.Inbound.BasicInfo.InboundDestinationRequired")]

        public bool IsForIndividual { get; set; }   //نوع جهة الواردة//
        ...
        [CustomStringLength("User.Inbound.IntendedPerson", 100 , 0)]
