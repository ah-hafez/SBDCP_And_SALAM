...
namespace MCS.GridMvc.Html
{
    ...
    {
        IGridHtmlOptions<T> CollectionName(string collectionName);
        ...
        ///     Set Delete Button
        /// </summary>
        /// <param name="deleteActionUrl"></param>
        /// <param name="columnIndex"></param>
        /// <param name="formId"></param>
        /// <param name="divDataUpdate"></param>
        /// <param name="onAjaxSuccess"></param>
        /// <param name="validFunctionCall"></param>
        /// <returns></returns>
        IGridHtmlOptions<T> RenderDeleteButton(string deleteActionUrl, int columnIndex, string formId, string divDataUpdate, string onAjaxSuccess = "", string validFunctionCall = "");
        /// <summary>
        ///     Set the default sort column
        /// </summary>
        IGridHtmlOptions<T> DefaultSortColumn(string columnName);
        /// <summary>
        ...
        /// <returns></returns>
        IGridHtmlOptions<T> UpdateActionUrl(string url);
        /// <summary>
