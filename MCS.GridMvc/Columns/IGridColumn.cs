...
namespace MCS.GridMvc.Columns
{
    ...
    public interface IColumn<T>
    {
        ...
        IGridColumn<T> Titled(string title, string tag = "");
        ...
        ///     Render column
        /// </summary>
        /// <param name="RenderDataIf">If true values from this column will be rendered</param>
        IGridColumn<T> RenderDataIf(Func<T, bool> constraint);
    ...
    public interface IColumn
    {
        ...
        bool RenderEnabled(object instance);
