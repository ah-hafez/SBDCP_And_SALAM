...
{
    /// <summary>
    /// Indicates whether or not a new transactionContextScope will join the ambient scope.
    /// </summary>
    public enum transactionContextScopeOption
    {
        /// <summary>
        /// Join the ambient transactionContextScope if one exists. Creates a new
        /// one otherwise.
        /// 
        /// This is what you want in most cases. Joining the existing ambient scope
        /// ensures that all code within a business transaction uses the same TransactionContext
        ...
        /// <summary>
        /// Ignore the ambient transactionContextScope (if any) and force the creation of 
        /// a new transactionContextScope. 
        /// 
        /// This is an advanced feature that should be used with great care. 
        /// 
        /// When forcing the creation of a new scope, new TransactionContext instances will be 
        /// created within that inner scope instead of re-using the TransactionContext instances that
