...
namespace MCS.Common.TransactionContext
{
    ...
    {
        private TransactionContextScope _savedScope;
        private bool _disposed;

        public AmbientContextSuppressor()
        {
            _savedScope = TransactionContextScope.GetAmbientScope();
            ...
            // is safe.
            TransactionContextScope.HideAmbientScope();
        }
        ...
        public void Dispose()
        {
            ...
            if (_savedScope != null)
            {
                TransactionContextScope.SetAmbientScope(_savedScope);
                _savedScope = null;
            }
