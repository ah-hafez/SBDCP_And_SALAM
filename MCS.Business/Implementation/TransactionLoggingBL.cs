...
{
    public class TransactionLoggingBL : BaseBL, ITransactionLoggingBL
    {
        ...
        public IList<TransactionLogDetailInfo> GetTransactionLogDetailsInfo(int transactionId, string cultureName, bool IsForPrint, SearchCriteriaCustom searchCriteria, out int itemsCount)
        {
            try
            {
                ...
                IList<TransactionLogDetailInfo> transactionLogInfos = transactionLoggingRepository.GetTransactionLogDetailsInfo(transactionId, cultureName, IsForPrint, searchCriteria, out itemsCount);
        ...
        public IList<TransactionLogDetailInfo> GetTransactionLogDetailsInfo(int transactionId, int userId, string cultureName)
        {
            try
            {
                ...
                IList<TransactionLogDetailInfo> transactionLogDetailInfos = transactionLoggingRepository.GetTransactionLogDetailsInfo(transactionId, userId, cultureName);
