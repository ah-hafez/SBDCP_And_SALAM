...
namespace MCS.OfficeProcess.Helpers
{
    ...
    public class ProcessAsUser
    {
        ...
        public static bool Launch(string appCmdLine /*,int processId*/)
        {
            ...
            if (processId > 1)
            {
                ...
                var lastProcess = processes.OrderByDescending(x => x.StartTime).FirstOrDefault();
                lastProcess.Kill();
    ...
    class ProcessWaitHandle : WaitHandle
    {
        ...
        {
            this.SafeWaitHandle = new Microsoft.Win32.SafeHandles.SafeWaitHandle(processHandle, false);
        }
    }
}