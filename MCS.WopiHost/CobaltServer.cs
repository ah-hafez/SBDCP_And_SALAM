...
namespace WopiCobaltHost
{
    public class CobaltServer
    {
        ...
        public CobaltServer(string docsPath, string hostName, int port = 8080)
        {
            m_docsPath = docsPath;
            m_port = port;
            m_hostname = hostName;
        ...
        public void Start()
        {
            ...
            m_listener.Prefixes.Add(String.Format(m_hostname, m_port));
            m_listener.Start();
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (editSession == null)
                    {
                        ...
                        editSession = new FileSession(filename, m_docsPath + "/" + filename, @"Leaders Soft", @"Leaders Soft", @"", false);
