...
namespace MCS.Framework.Controls.Barcode
{
    ...
    public abstract class BarcodeDraw
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="T:MCS.Framework.Controls.Barcode.BarcodeDraw"/> class.
        /// </summary>
        ...
        /// <param name="metrics">A <see cref="T:MCS.Framework.Controls.Barcode.BarcodeMetrics"/> object.</param>
        /// <returns>
        ...
        /// <summary>
        /// Gets a <see cref="T:MCS.Framework.Controls.Barcode.BarcodeMetrics"/> object containing default
        /// settings for the specified maximum bar height.
        /// </summary>
        /// <param name="maxHeight">The maximum barcode height.</param>
        /// <returns>A <see cref="T:MCS.Framework.Controls.Barcode.BarcodeMetrics"/> object.</returns>
    ...
    /// A <see cref="T:MCS.Framework.Controls.Barcode.GlyphFactory"/> derived type.
    /// </typeparam>
    /// <typeparam name="TChecksum">
    /// A <see cref="T:MCS.Framework.Controls.Barcode.Checksum"/> derived type.
    /// </typeparam>
        ...
        where TChecksum : Checksum
    {
        ...
        #region Protected Constructors
        /// <summary>
        /// Initialises an instance of <see cref="T:MCS.Framework.Controls.Barcode.BarcodeDraw"/>.
        /// </summary>
        ...
        /// <returns>A collection of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects.</returns>
        ...
        /// </summary>
        /// <param name="glyph">A <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> to be queried.</param>
        ...
        /// If the glyph implements <see cref="T:MCS.Framework.Controls.Barcode.IVaryLengthGlyph"/> then the
        ...
        /// </summary>
        /// <param name="barcode">
        /// Collection of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects to be rendered.
        /// </param>
        ...
        /// </summary>
        /// <param name="barcode">A collection of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects representing the
        ...
        /// <param name="glyph">A <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> object to be rendered.</param>
        /// <param name="dc">A <see cref="T:System.Drawing.Graphics"/> representing the draw context.</param>
        /// <param name="bounds">The bounding rectangle.</param>
