...
namespace MCS.Framework.Controls.Barcode
{
    ...
    public abstract class GlyphFactory
    {
        ...
        /// <see cref="T:MCS.Framework.Controls.Barcode.GlyphFactory"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:MCS.Framework.Controls.Barcode.BarGlyph"/> at the specified
        /// ordinal index.
        /// </summary>
        /// <param name="index">The glyph ordinal index.</param>
        /// <returns>
        /// A <see cref="T:MCS.Framework.Controls.Barcode.BarGlyph"/> glyph object.
        /// </returns>
        ...
        /// <summary>
        /// Gets the <see cref="T:MCS.Framework.Controls.Barcode.BarGlyph"/> that corresponds
        ...
        /// </summary>
        /// <param name="glyph">
        /// The <see cref="T:MCS.Framework.Controls.Barcode.BarGlyph"/> to be located.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Gets the array of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects that
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:MCS.Framework.Controls.Barcode.BarGlyph"/> that 
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:MCS.Framework.Controls.Barcode.CompositeGlyph"/>
        /// that represent the composite bar-code glyphs for the given bar-code
        /// symbology.
        /// </summary>
        /// <returns>
        /// The full collection of <see cref="T:MCS.Framework.Controls.Barcode.CompositeGlyph"/>
