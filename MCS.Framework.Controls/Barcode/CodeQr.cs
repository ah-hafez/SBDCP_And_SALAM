    ...
    public class CodeQrBarcodeDraw : BarcodeDraw
    {
        ...
        private class QRCodeEncoder
        {
            ...
            public virtual bool[][] CalculateQrCode(byte[] qrcodeData)
            {
                ...
                for (int i = 0; i < 15; i++)
                {
                    sbyte content = System.SByte.Parse(formatInformationArray[formatInformationValue].Substring(i, (i + 1) - (i)));
        ...
        /// <returns>
        /// A <see cref="T:MCS.Framework.Controls.Barcode.BarcodeMetrics"/> object.
        /// </returns>
