...
namespace MCS.Framework.Controls.Barcode
{
    ...
    /// sole abstract method <see cref="M:MCS.Framework.Controls.Barcode.Checksum.GetChecksum"/>.
    /// </remarks>
    public abstract class Checksum
    {
        #region Protected Constructors
        /// <summary>
        /// Initialises a new instance of <see cref="T:MCS.Framework.Controls.Barcode.Checksum"/> class.
        /// </summary>
        protected Checksum()
        {
        }
        ...
        /// <summary>
        /// Gets an array of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects that
        /// represent the checksum for the specified text string.
        /// </summary>
        /// <param name="text">Text to be processed.</param>
        /// <returns>
        /// A collection of <see cref="T:MCS.Framework.BarcodeGlyph"/> objects 
        ...
        /// <returns>
        /// A collection of <see cref="T:MCS.Framework.Controls.Barcode.Glyph"/> objects 
        /// representing the checksum information.
        /// </returns>
    ...
    /// that are attached to an object derived from <see cref="T:MCS.Framework.Controls.Barcode.GlyphFactory"/>
    /// for fetching the checksum glyph characters.
    /// </summary>
    /// <typeparam name="T">
    /// A factory class derived from <see cref="T:MCS.Framework.Controls.Barcode.GlyphFactory"/>.
    /// </typeparam>
        ...
        where T : GlyphFactory
    {
        ...
        #region Protected Constructors
        /// <summary>
        /// Initialises a new instance of <see cref="T:MCS.Framework.Controls.Barcode.FactoryChecksum"/>
        /// class with the specified <see cref="T:MCS.Framework.Controls.Barcode.GlyphFactory"/> derived
        /// object.
        /// </summary>
        /// <param name="factory">
