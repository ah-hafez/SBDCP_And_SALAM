		...
		this.events.subscribe(
			...
			, function(){
				...
				var renderer = function(){
					...
					, $img = $('<img style="display:none;position:absolute !important; top: auto; min-width:90px !important; max-width:180px !important;width:10% !important;border:none !important;padding: 0 !important;margin:0 !important;box-shadow:0 0 0 !important;" />')
					try {
						$img[0].src = data
						return $img
					} catch (ex) {
