...
jQuery.fn.contextPopup = function (menuData) {
    ...
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) )  {
        ...
        this.on('touchstart', function (e) {
            ...
            left = e.originalEvent.touches[0].clientX + 5; /* nudge to the right, so the pointer is covering the title */
        ...
        this.on('touchend', function (e) {
            ...
            if (e.target !== this)
                ...
                if (e.originalEvent.touches.length == 0) { // User just took last finger off screen


                    if (deltaY == 0) { // User didn't move finger much up or down
...
jQuery.fn.contextPopupLink = function (menuData) {
    // Define default settings
    var settings = {
        contextMenuClass: 'contextMenuPlugin',
        linkClickerClass: 'contextMenuLink',
    ...
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        this.on('contextmenu click', function (e) {
            var menu = createMenu(e)
              .show();
...
$(document).mouseup(function (e) {
    var popup = $(".contextMenuPlugin");
    if (!$('.contextMenuLink').is(e.target) && !popup.is(e.target) && popup.has(e.target).length == 0) {
        popup.remove();
    }
})