...
namespace MCS.Framework.Controls.Mvc
{
    ...
    public class GridHtmlOptions<T> : IGridHtmlOptions<T> where T : class
    {
        ...
        public IGridHtmlOptions<T> SetHeaderClass(string cssClass)
        {
            _source.SetHeaderClass(cssClass);
            return this;
        }

        public IGridHtmlOptions<T> SetBodyClass(string cssClass)
        {
            _source.SetBodyClass(cssClass);
            return this;
        }
