...
namespace MCS.Framework.Controls.Mvc
{
    ...
    public abstract class GridBase<T> where T : class
    {
        ...
        public bool UseGridFunctionality { get; set; }
            ...
            get
            {
                ...
                if (!_itemsPreProcessed)
                {
                    _itemsPreProcessed = true;
                        ...
                        {
                            BeforeItems = gridItemsProcessor.Process(BeforeItems, UseGridFunctionality);
                        }
        ...
        {
            return "class=" + headerCssClass;
        }

        public string GetBodyClass()
        {
            return "class=" + BodyCssClass;
        }
        ...
        protected void PrepareItemsToDisplay()
        {
            if (!_itemsProcessed)
            {
                ...
                {
                    itemsToProcess = processor.Process(itemsToProcess,UseGridFunctionality);
                }
