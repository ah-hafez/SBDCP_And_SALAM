...
using System.Web;
using MCS.Framework.Controls.Barcode;
...
namespace MCS.Framework.Controls.Mvc
{
    ...
    /// <![CDATA[
    /// <add verb="GET" path="*.Barcode" type="MCS.Framework.Controls.Barcode.Web.BarcodeImageHandler, MCS.Framework.Controls.Barcode.Web, Culture=Neutral, Version=2.0.3.0, PublicKeyToken=b5ae55aa76d2d9de" />
    /// ]]>
    ...
    public class BarcodeImageUri
    {
        ...
        private static readonly object syncParser = new object();
        private static Regex _filenameParser;

        private static readonly object syncQrParser = new object();
        ...
        private void DecodeFileName()
        {
            ...
            using (MemoryStream memStm = new MemoryStream(encryptedFileName))
            {
                using (StreamReader reader = new StreamReader(memStm, Encoding.UTF8))
                {
